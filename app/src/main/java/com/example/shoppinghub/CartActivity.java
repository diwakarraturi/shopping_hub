...
import com.example.shoppinghub.ViewHolder.CartViewHolder;
import com.example.shoppinghub.model.Cart;
    ...
    private void CheckOrderStatus(){
        ...
        orderRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    String shipingStatus = snapshot.child("state").getValue().toString();
                    String userName = snapshot.child("name").getValue().toString();

                    if(shipingStatus.equals("shipped")){
                        txtTotalAmount.setText("Dear"+ userName+ "\n order shipped successfully");
                        recyclerView.setVisibility(View.GONE);
                        txtMsg1.setVisibility(View.VISIBLE);
                        txtMsg1.setText("Congratulation, your final order has been Shipped successfully. Soon you will recieve your order at your address");
                    ...
                    else if(shipingStatus.equals("not shipped")){
